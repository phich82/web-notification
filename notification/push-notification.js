 ...
 * @alias PushNotification.initPushNotification
 * @private
 ...
 */
(function initPushNotification(global, factory) {
    'use strict';

    /*istanbul ignore next*/
    const NotificationAPI = global.Notification || window.Notification;

    const PushNotification = factory(NotificationAPI);
     ...
     * @function
     * @memberof! PushNotification
     * @alias PushNotification.initPushNotificationFromContext
     * @private
     * @param {Object} context - The root context (window/global/...)
     * @returns {Object} New instance of the API
     */
    PushNotification.initPushNotificationFromContext = function (context) {
        return initPushNotification(context, factory);
    };
    ...
    return PushNotification;
}(this, function initPushNotification(NotificationAPI) {
    'use strict';
     ...
     *
     * @memberof! PushNotification
     * @alias PushNotification.Lib
     * @private
     */
    PushNotification.Lib = NotificationAPI;
     ...
     * @member {Boolean}
     * @memberof! PushNotification
     * @alias PushNotification.allowRequest
     * @public
     */
    PushNotification.allowRequest = true; //true to enable automatic requesting of permissions if needed

    /*eslint-disable func-name-matching*/
    Object.defineProperty(PushNotification, 'permissionGranted', {
        /**
     ...
     * @function
     * @memberof! PushNotification
     * @alias PushNotification.isEnabled
     * @private
     * @returns {Boolean} True if allowed to show web notifications
     */
    const isEnabled = function () {
        return PushNotification.permissionGranted;
    };
     ...
     * @function
     * @memberof! PushNotification
     * @alias PushNotification.createAndDisplayNotification
     * @private
    ...
    const createAndDisplayNotification = function (title, options, callback) {
        ...
        if (serviceWorkerRegistration) {
            ...
            if (!options.tag) {
                tagCounter++;
                options.tag = 'PushNotification-' + Date.now() + '-' + tagCounter;
            }
            const tag = options.tag;

            serviceWorkerRegistration.showNotification(title, options).then(function onCreate() {
                serviceWorkerRegistration.getNotifications({ tag })
            ...
            try {
                let instance = new NotificationAPI(title, options);
                instance && onNotification(instance);
            } catch (error) {
                callback(error);
            }
        }
     ...
     * @function
     * @memberof! PushNotification
     * @alias PushNotification.parseInput
     * @private
     ...
     * @function
     * @memberof! PushNotification
     * @alias PushNotification.requestPermission
     * @public
     ...
     * PushNotification.requestPermission(function onRequest(granted) {
     *  if (granted) {
     ...
     * ```
     */
    PushNotification.requestPermission = function (callback) {
     ...
     * @function
     * @memberof! PushNotification
     * @alias PushNotification.showNotification
     * @public
     * @param {String} [title] - The notification title text (defaulted to empty string if null is provided)
     * @param {Object} [options] - Holds the notification data (web notification API spec for more info)
     * @param {String} [options.icon=/favicon.ico] - The notification icon (defaults to the website favicon.ico)
     ...
     *   PushNotification.showNotification('Example Notification', {
     ...
     * ```
     */
    PushNotification.showNotification = function () {
        ...
        if ((argumentsArray.length >= 1) && (argumentsArray.length <= 3)) {
            ...
            PushNotification.requestPermission(function onRequestDone(granted) {
                if (granted) {
